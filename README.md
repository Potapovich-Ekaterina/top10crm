# Сравнительный анализ.ТОП 5 WMS 

## [ YOLKA WMS ](https://yolka.io/wms)

- Цена: -- 6900 рос. руб

- Условия пользования:---регистрация и приобретение пакета

- Функционал:---Полноценная система управления складской операционной деятельностью.

- Сфера применения:---- Усистема управления складом, предназначенная для малых и средних компаний.

- Отзывы клиентов: ---положительные ***например:*** Третий месяц управляем складом с помощь программного обеспечения Yolka.WMS. Софтом довольны на все 100%! Порадовал не только функционал ПО, но и лояльное отношение сотрудников компании к нам, как к клиентам. Процесс внедрения занял 3-4 дня и теперь все операции (приемка, размещение, учет сроков годности, штрих-кодирование, сортировка заказов, отгрузка, прием возврата и т. д.) осуществляются в автоматизированном порядке..

- Удобства использования:---Безопасность, сокращение времени в работе.
Удобный интерфейc

## [ 1С:ПРЕДПРИЯТИЕ 8. WMS ЛОГИСТИКА ](https://solutions.1c.ru/catalog/wms4/features)

- Цена:--- 14 597,64 BYN

-*Условия пользования: - регистрация и приобретение пакета

- Функционал:--  позволяет оптимизировать процессы и решить основные проблемы, актуальные для складских комплексов:
...
- Сфера применения: ---предназначена для управления процессами складской грузообработки в режиме реального времени, а именно:
...
- Отзывы клиентов:---положительные , например: Из положительных моментов могу выделить – систему можно настроить под нужды предприятия, все важные данные находятся в одном месте, и доступны в режиме реального времени, минимизирован риск человеческого фактора (программа полностью автоматизирует рабочий процесс), выдерживает высокие нагрузки и пр. В случае необходимости можно докупить модули. Мы довольны системой, и рекомендуем внедрять крупным компаниям по логистике и складу.
